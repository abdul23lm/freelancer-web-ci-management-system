...
class Restore extends CI_Controller {
	...
	public function upload()
	{
		...
		if(!empty($cek))
		{
			...
			{
				$this->db->query("TRUNCATE TABLE lmcp_daftar_desain");
				$this->db->query("TRUNCATE TABLE lmcp_gaji_karyawan");
				$this->db->query("TRUNCATE TABLE lmcp_jenis_desain");
				$this->db->query("TRUNCATE TABLE lmcp_jenis_satuan");
				$this->db->query("TRUNCATE TABLE lmcp_karyawan");
				$this->db->query("TRUNCATE TABLE lmcp_kwitansi");
				$this->db->query("TRUNCATE TABLE lmcp_pelanggan");
				$this->db->query("TRUNCATE TABLE lmcp_pembayaran");
				$this->db->query("TRUNCATE TABLE lmcp_pemesanan");
				$this->db->query("TRUNCATE TABLE lmcp_pemesanan_detail");
				$this->db->query("TRUNCATE TABLE lmcp_sessions");
				$this->db->query("TRUNCATE TABLE lmcp_setting");
				$this->db->query("TRUNCATE TABLE lmcp_user");
