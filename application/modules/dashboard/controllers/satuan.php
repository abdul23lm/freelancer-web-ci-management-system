...
class satuan extends CI_Controller {
	...
	function edit($id_param)
	{
		if($this->session->userdata("logged_in")!="")
		{
			...
			$get = $this->db->get_where("lmcp_jenis_satuan",$id)->row();
	...
	function simpan()
	{
		if($this->session->userdata("logged_in")!="")
		{
			...
			if($st=="tambah")
			{
				$this->db->insert("lmcp_jenis_satuan",$dt);
				redirect("dashboard/satuan");
			}
			else if($st=="edit")
			{
				$this->db->update("lmcp_jenis_satuan",$dt,$id);
				redirect("dashboard/satuan");
			}
		}
		else
	...
	function hapus($id_param)
	{
		...
		{
			$id['id_jenis_satuan'] = $id_param;
			$get = $this->db->delete("lmcp_jenis_satuan",$id);
			redirect("dashboard/satuan");
		}
		else
		{
