	...
	<div class="box span12">
		...
		<div class="box-content">
			...
			<select name="key_search">
				<option value="nama_pelanggan">Nama Client</option>
				<option value="a.kode_pemesanan">Kode pemesanan</option>
			</select>
			<input type="submit" value="Cari Data" class="btn" />
			<?php echo form_close(); ?>
			<?php echo $dt_retrieve; ?>
			<span class="label label-success">JUMLAH DATA : <?php echo $this->db->get_where("lmcp_pemesanan",array("status_pembayaran"=>"Belum Lunas"))->num_rows(); ?></span>
		</div>
	</div>
