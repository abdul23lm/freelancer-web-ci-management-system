			...
			<?php echo form_open("dashboard/pemesanan/simpan",'class="form-horizontal" name="frm_pesan"'); ?>
			  <fieldset>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<select data-placeholder="Cari Nama Client..." class="chzn-select" style="width:400px;" tabindex="2" name="kode_pelanggan" id="kode_pelanggan">
          		<option value=""></option> 
					<?php
				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
					<thead>
						<tr>
							<th>No.</th>
							<th>Nama Jenis Desain</th>
							<th>Jumlah</th>
							<th>Harga</th>
							<th>Subtotal</th>
							<th><a href="<?php echo base_url(); ?>dashboard/pemesanan/tambah_item" class="cbbarang btn btn-warning btn-small">Tambah Desain</a></th>
						</tr>
					</thead> 
					<?php $i = 1; $no=1;?>
