...
<body>
	...
	<div class="well">
	<h1>Data - Master Jenis Desain</h1>
		<div id="body">
		<?php $atr = array('name' => 'frm', 'id' => 'frm'); echo form_open('dashboard/pemesanan/tambah_barang_pesanan',$atr); ?>
			<table width="100%" cellpadding="3" cellspacing="0">
				<tr><td width="130">Nama Desain</td><td>:</td><td>
				<select data-placeholder="Cari Nama Desain..." class="chzn-select" style="width:400px;" tabindex="2" name="kode_jenis_cetakan" id="kode_jenis_cetakan">
          		<option value=""></option> 
					<?php
